    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-center space-x-4 py-1">
                ...
                <button type="button" onClick={() => setWithVideo(!withVideo)} className={`${withVideo ? 'bg-green-600' : 'bg-gray-400 dark:bg-gray-500'} relative inline-flex h-7 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-light-card dark:focus:ring-offset-dark-bg`} aria-pressed={withVideo}>
        ...
        <>
            <div className="w-full h-full flex flex-col justify-center p-6 sm:p-8 bg-dark-bg text-light-text dark:text-white">
                <div className="w-full max-w-sm mx-auto">
                    <h1 className="text-4xl font-bold mb-6 text-center text-purple-600 dark:text-purple-400">Phone</h1>
                    {isCalling ? (
