...
import { PlayIcon, QuestionMarkCircleIcon, ChatBubbleBottomCenterTextIcon } from '@heroicons/react/24/solid';
    ...
    return (
        <>
            ...
            <div className="fixed bottom-5 right-5 flex flex-col items-center space-y-3 z-50">
                 <a href="https://www.youtube.com/@DarCodR" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-700 dark:bg-gray-800 rounded-full flex items-center justify-center text-white hover:bg-red-600 transition-colors shadow-lg group">
                ...
                <button onClick={() => setHelpModalOpen(true)} className="w-14 h-14 bg-indigo-600 rounded-full flex items-center justify-center text-white hover:bg-indigo-700 transition-colors shadow-lg group">
