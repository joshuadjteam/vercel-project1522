...
const HistoryApp: React.FC<HistoryAppProps> = ({ navigate }) => {
    return (
        <div className="w-full h-full flex items-center justify-center bg-dark-bg text-light-text dark:text-white">
             <div className="text-center">
                <h1 className="text-3xl font-bold mb-4">History Removed</h1>
