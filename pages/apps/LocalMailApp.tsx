...
import { InboxIcon, PaperAirplaneIcon, PencilSquareIcon, TrashIcon, ArrowUturnLeftIcon } from '@heroicons/react/24/outline';
                        ...
                        {selectedMail ? (
                            <div>
                                <div className="flex justify-between items-start pb-4 border-b border-gray-200 dark:border-teal-700/50">
                                    ...
                                    <button onClick={() => handleDeleteMail(selectedMail.id)} className="p-2 rounded-md hover:bg-red-600/20 dark:hover:bg-red-600/50 text-gray-500 dark:text-gray-300 hover:text-red-500 dark:hover:text-white transition-colors">
