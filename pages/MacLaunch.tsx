                ...
                <div className="bg-white/20 backdrop-blur-xl border border-white/20 rounded-2xl px-2 py-2 flex items-end space-x-2 shadow-2xl">
                    {DOCK_APPS.map(app => (
                        ...
                        >
                            ...
                            <span className="absolute -top-8 bg-black/70 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">{app.label}</span>
                        </button>
                    ))}
                    ...
                    >
                        <SettingsIcon />
                        <span className="absolute -top-8 bg-black/70 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">System Preferences</span>
                    </button>
                </div>
            </div>
        </div>
